...
public class ControllerImpl implements Controller{
    ...
    public String report() {
        ...
        for (Magician magician : magicianList) {
            ...
            stringBuilder.append(String.format("%s: %s", magician.getClass().getSimpleName(), magician.getUsername()))
                    .append(System.lineSeparator())
                    .append(String.format("Health: %d", protection)).append(System.lineSeparator())
